...
import { initInitData } from '@telegram-apps/sdk'; // для локальной разработки нужно закоментить
...
const Wild = () => {
  ...
  const initData = initInitData(); // для локальной разработки нужно закоментить
  const userID = initData?.user?.id; // для локальной разработки нужно закоментить
  // const userID = 123 // для локальной разработки разкоментить
